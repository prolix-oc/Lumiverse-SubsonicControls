...
export interface SearchUI { root: HTMLElement; setResults(results: SearchResult[]): void; setAvailable(available: boolean): void; setPlaybackAvailable(available: boolean): void; destroy(): void; }
